        ...
        return (
            <div className="xblock xblock-student_view xblock-student_view-vertical" data-runtime-class="LmsRuntime" data-init="VerticalStudentView" data-course-id="course-v1:B9lab+HLF-12+2018-07" data-request-token="c4eb961eaa5611e8be1d0a059cba8688" data-runtime-version={1} data-usage-id="block-v1:B9lab+HLF-12+2018-07+type@vertical+block@171fa047cb7a4164bdd8d36e6bc28f83" data-block-type="vertical">
                ...
                <div className="vert vert-0" data-id="block-v1:B9lab+HLF-12+2018-07+type@html+block@7c38010a996d49399836f22416652279">
                    <div className="xblock xblock-student_view xblock-student_view-html xmodule_display xmodule_HtmlModule" data-runtime-class="LmsRuntime" data-init="XBlockToXModuleShim" data-block-type="html" data-request-token="c4eb961eaa5611e8be1d0a059cba8688" data-runtime-version={1} data-usage-id="block-v1:B9lab+HLF-12+2018-07+type@html+block@7c38010a996d49399836f22416652279" data-type="HTMLModule" data-course-id="course-v1:B9lab+HLF-12+2018-07">
                    <h1>Go</h1>
                    ...
                    <pre><code className="hljs golang">func variadicFunction(a ...interface{"{"}{"}"}) {"{"}{"\n"}{"    "}for _,s:= range a {"{"}{"\n"}{"        "}// do something{"\n"}{"    "}{"}"}{"\n"}{"}"}{"\n"}</code></pre>
                    ...
                    <pre><code className="hljs golang">// Copyright 2011 The Go Authors. All rights reserved.{"\n"}// Use of this source code is governed by a BSD-style{"\n"}// license that can be found in the LICENSE file.{"\n"}{"\n"}// Package errors implements functions to manipulate errors.{"\n"}package errors{"\n"}{"\n"}// New returns an error that formats as the given text.{"\n"}func New(text string) error {"{"}{"\n"}{"      "}return &amp;errorString{"{"}text{"}"}{"\n"}{"}"}{"\n"}{"\n"}// errorString is a trivial implementation of error.{"\n"}type errorString struct {"{"}{"\n"}{"      "}s string{"\n"}{"}"}{"\n"}{"\n"}func (e *errorString) Error() string {"{"}{"\n"}{"      "}return e.s{"\n"}{"}"}{"\n"}</code></pre>
